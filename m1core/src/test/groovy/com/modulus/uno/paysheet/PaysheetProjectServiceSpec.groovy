...
class PaysheetProjectServiceSpec extends Specification {
  ...
  void "Should create users for employees from paysheet project"() {
    given:"The paysheet project"
      ...
      PaysheetContract paysheetContract = new PaysheetContract(company:company)
    ...
    and:
      corporateService.getCorporateFromCompany(_) >> new Corporate(nameCorporate:"CORPORATE", companies:[company]).save(validate:false)
    when:
    ...
    then:
      ...
      1 * corporateService.getCorporateFromCompany(_)
  }
