...
class XlsImportService {
  ...
  Map COLUMN_MAP_CLIENT = [
    startRow: 1,
    columnMap:  ['A':'PERSONA', 'B':'RFC', 'C':'SITIO_WEB', 'D':'RAZON_SOCIAL', 'E':'PATERNO', 'F':'MATERNO', 'G':'NOMBRE', 'H':'CLAVE_BANCO', 'I':'ULTIMOS_4_DIGITOS_TARJETA', 'J':'CALLE', 'K':'NUMEXTERIOR', 'L':'NUMINTERIOR', 'M':'CODIGO_POSTAL', 'N':'COLONIA', 'O':'DELEGACION/MUNICIPIO', 'P':'PAIS', 'Q':'CIUDAD', 'R':'ENTIDAD_FEDERATIVA', 'T':'TIPO_DE_DIRECCION']
  ]
