...
<div class="row">
  <div class="col-md-6">
    ...
    <g:if test="${employee.paysheetReceiptUuidSA}"> 
      ...
      <g:if test="${[PaysheetEmployeeStatus.IMSS_STAMPED, PaysheetEmployeeStatus.FULL_STAMPED_XML_IMSS_PDF, PaysheetEmployeeStatus.FULL_STAMPED].contains(employee.status)}">
      ...
      <sec:ifAnyGranted roles="ROLE_FICO_EJECUTOR">
        <g:if test="${[PaysheetEmployeeStatus.IMSS_STAMPED_XML, PaysheetEmployeeStatus.FULL_STAMPED_XML_ASSIMILABLE_PDF, PaysheetEmployeeStatus.FULL_STAMPED_XML].contains(employee.status)}">
  ...
  <div class="col-md-6">
    ...
    <g:if test="${employee.paysheetReceiptUuidIAS}">
      ...
      <g:if test="${[PaysheetEmployeeStatus.ASSIMILABLE_STAMPED, PaysheetEmployeeStatus.FULL_STAMPED_XML_ASSIMILABLE_PDF, PaysheetEmployeeStatus.FULL_STAMPED].contains(employee.status)}">
      ...
      <sec:ifAnyGranted roles="ROLE_FICO_EJECUTOR">
        <g:if test="${[PaysheetEmployeeStatus.ASSIMILABLE_STAMPED_XML, PaysheetEmployeeStatus.FULL_STAMPED_XML_IMSS_PDF, PaysheetEmployeeStatus.FULL_STAMPED_XML].contains(employee.status)}">
