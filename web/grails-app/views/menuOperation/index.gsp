...
<html>
    ...
    <body>
        <a href="#list-menuOperation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="list-menuOperation" class="content scaffold-list" role="main">
            ...
            <f:table collection="${menuOperationList}" />
