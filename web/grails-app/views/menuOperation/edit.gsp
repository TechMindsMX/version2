...
<html>
    ...
    <body>
        <a href="#edit-menuOperation" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="edit-menuOperation" class="content scaffold-edit" role="main">
