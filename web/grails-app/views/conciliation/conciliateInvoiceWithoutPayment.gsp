            ...
            <div class="container-fluid">
              ...
              <div class="row">
                <div class="form-group">
                  <label>Monto a aplicar <font color="red">*</font>:</label>
                  <input class="form-control" type="number" min="0.01" max="${saleOrder.amountToPay}" step="0.01" name="amountToApply" required="true"/>
                </div>
              </div>
              ...
              <div class="row">
                <div class="form-group">
                  ...
                  <g:if test="${saleOrder.currency == 'USD'}">
                    <input class="form-control" type="number" min="0.01" step="0.01" required="true" name="changeType" value="0.00"/>
                  </g:if>
                  <g:else>
